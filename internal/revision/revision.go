...
// Commit is set by mise build to the source checkout's commit rather than a branch name.
...
func Validate(value string) error {
	...
	return fmt.Errorf("invalid installer revision %q: use mise build from a clean checkout", value)
}
